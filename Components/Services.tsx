        ...
        <div data-aos='fade-right' className=''>
          <div className="bg-red-700 hover:scale-110 transform transition-all duration-300 hover:-rotate-6 uppercase font-semibold text-center p-[2rem]">
            ...
            <p className='text-[15px] text-[#d3d2d2] font-normal'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit alias quisquam ducimus ullam deserunt odio ut mollitia placeat quibusdam beatae, voluptatum a numquam eligendi ipsa!
            </p>
          </div>
        </div>
        <div data-aos='zoom-in' data-aos-delay='300' className=''>
