  ...
  return (
    <div className='flex flex-col text-center justify-center'>
      ...
      <p className="text=[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia labore quibusdam, doloribus saepe iusto molestias in, tempora earum et aliquid inventore. Similique voluptate nulla provident! Facilis quaerat rerum beatae iure.
      </p>
    </div>
  )
}
